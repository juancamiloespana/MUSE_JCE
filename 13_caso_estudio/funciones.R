...
suc1=1
ajustar_modelo=function(url, suc1)
{
...
definir_solicitudes= function(h=2,suc1)
...
modelo=ajustar_modelo(url,1)

medidas=medir_modelo(modelo, sign=0.05,h =2)


url='https://github.com/juancamiloespana/MUSE_JCE/raw/master/flujo_efectivo.csv'
h=2
