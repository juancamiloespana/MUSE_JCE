...
emp.pilot <- Employees[sam] ###Variable de interés, ingresos.
...
n_sd=3  ## Número de desviaciones para una probabilidad de 95%
s=sd(emp.pilot)
...
p1 <- qplot(SPAM, Employees, data=BigLucy, geom=c("boxplot"))
